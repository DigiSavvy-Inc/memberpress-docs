# I Can’t Upload MemberPress – File Size too Large | MemberPress
...
Some of our users have reported getting an error when trying to upload MemberPress, stating that the file is too large. The most common output for this error is:

The uploaded file exceeds the upload_max_filesize directive in php.ini

If you are seeing this, or a similar message, you need to contact your host (we cannot resolve this for you) to either:

If at all possible, you should strive to see that #1 is done over #2 simply because most quality plugins will be of a similar size as MemberPress.
