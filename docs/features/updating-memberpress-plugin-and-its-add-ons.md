# Updating MemberPress Plugin and Its Add-ons
...
MemberPress plugins and add-ons updates provide security updates, new features, and other enhancements. Updating MemberPress and add-ons ensures these plugins continue functioning well with WordPress, themes, and other plugins on your website.

This document explains how to update the MemberPress core plugin and add-ons. Furthermore, the document will guide you through both the automatic and manual updating process.

## Automatic MemberPress Updates

MemberPress settings (MemberPress > Settings > General tab > Automatic Updates section) enable automatic updates by default. Therefore, the default option set will be to apply All updates released. Furthermore, if necessary, you can change this to Minor Updates Only or None (disabled).

![MemberPres Automatic Updates](data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyNTQzIiBoZWlnaHQ9IjEzMTYiIHZpZXdCb3g9IjAgMCAyNTQzIDEzMTYiPjxyZWN0IHdpZHRoPSIxMDAlIiBoZWlnaHQ9IjEwMCUiIHN0eWxlPSJmaWxsOiNjZmQ0ZGI7ZmlsbC1vcGFjaXR5OiAwLjE7Ii8+PC9zdmc+)
Here, if you disable automatic updates, you will still receive notifications about MemberPress core plugin or add-on updates. Therefore, you can decide whether to update the plugin and do the update at a time that fits your schedule.

Note: Disabling automatic updates is advisable if you have custom integrations or custom solutions developed for MemberPress on your website. Since each update brings some changes, checking the MemberPress or add-on changelog before updating is advisable to avoid issues.

## Updating MemberPress Manually

If, for any reason, automatic updates are not possible or do not meet your needs, you can update plugins manually. To update MemberPress or add-ons manually, follow these steps:

Note: Additionally, please keep in mind that only users with specific permission can update plugins. Therefore, you must log in to your website with the user who has permission to manage plugins. By default, these are users with the Administrator user role.

![Install A Plugin Update](data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyNTQzIiBoZWlnaHQ9IjEzMTYiIHZpZXdCb3g9IjAgMCAyNTQzIDEzMTYiPjxyZWN0IHdpZHRoPSIxMDAlIiBoZWlnaHQ9IjEwMCUiIHN0eWxlPSJmaWxsOiNjZmQ0ZGI7ZmlsbC1vcGFjaXR5OiAwLjE7Ii8+PC9zdmc+)![Install A Plugin Update](https://memberpress.com/wp-content/uploads/2024/02/mepr-upload-plugin.png)

![Upload the plugin update](data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyNTQ0IiBoZWlnaHQ9IjEzMTUiIHZpZXdCb3g9IjAgMCAyNTQ0IDEzMTUiPjxyZWN0IHdpZHRoPSIxMDAlIiBoZWlnaHQ9IjEwMCUiIHN0eWxlPSJmaWxsOiNjZmQ0ZGI7ZmlsbC1vcGFjaXR5OiAwLjE7Ii8+PC9zdmc+)![Upload the plugin update](https://memberpress.com/wp-content/uploads/2024/02/mepr-choose-and-install-plugin.png)

![Updating MemberPress](data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyNTU2IiBoZWlnaHQ9IjEzMTYiIHZpZXdCb3g9IjAgMCAyNTU2IDEzMTYiPjxyZWN0IHdpZHRoPSIxMDAlIiBoZWlnaHQ9IjEwMCUiIHN0eWxlPSJmaWxsOiNjZmQ0ZGI7ZmlsbC1vcGFjaXR5OiAwLjE7Ii8+PC9zdmc+)![Updating MemberPress](https://memberpress.com/wp-content/uploads/2024/02/mepr-updating-memberpress-plugin-1.png)

Note: All your MemberPress-related data is stored in the database. Thus, your data and settings won't be lost when updating the plugin.
