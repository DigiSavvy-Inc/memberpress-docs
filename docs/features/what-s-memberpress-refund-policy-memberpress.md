# What’s MemberPress Refund Policy? | MemberPress
...
# What’s MemberPress Refund Policy?

You can purchase MemberPress-related products by buying subscriptions. Since MemberPress-related products aren't available as a free version or with a trial period, we offer a 14-day Refund Policy.

Note: By subscribing to any plan on MemberPress.com, you confirm that you agree to the MemberPress terms and 14-day Refund Policy.

This document explains the MemberPress 14-day Refund Policy and how to request a refund if needed.

## MemberPress 14-day Refund Policy

MemberPress's 14-day Refund Policy applies to new subscriptions and renewals but under different conditions.

### Refund Policy for New Subscriptions

The MemberPress 14-day Refund Policy allows you to test MemberPress features and ensure the products fit your requirements. During this period, you're guaranteed a 100% refund if the product is not a good fit.

When you subscribe to MemberPress for the first time, your MemberPress account and subscription will be automatically created. Also, your 14-day Refund Policy period will start at the moment you subscribe under the following conditions:

Note: MemberPress refunds can be issued only once. By requesting a refund (if issued), you're waiving your right to the 14-day Refund Policy, which won't be valid for future purchases of the same product. Thus, if you subscribe to MemberPress again, you won't be eligible for a refund for that purchase.

### Refund Policy for Renewals

If you find that MemberPress is the right product for you, you can simply continue to use it past the refund period. Your MemberPress subscription will renew automatically every year, extending your license indefinitely.

Note: All MemberPress subscriptions are renewed automatically, unless canceled, and do not require payment validation on renewals.

You will receive an email reminder about upcoming renewals every year before the renewal date. This will give you enough time to make arrangements in time or to make adjustments as needed.

Accordingly, if needed, you can cancel your MemberPress subscription anytime before the renewal date in your account.

Note: Automatic reminders will be sent to the email address you used to subscribe to MemberPress.

Still, if you miss canceling your subscription and it renews, you're covered by MemberPress's 14-day Renewal Refund Policy. Feel free to request a refund any time within 14 days following your subscription renewal.

Renewal refunds are issued under the same conditions as new subscription refunds, minus an administrative fee. Please check the Refunds section of MemberPress Terms and Conditions for more details.

## How To Request A Refund?

You can request a refund by submitting a support ticket.

Before requesting a refund, we suggest you check our knowledge base or contact our support team for assistance with MemberPress.
