# Email Marketing Platform Integrations by MemberPress Edition
...
MemberPress integrations allow you to connect MemberPress to almost any email marketing platform. Depending on your preferences and MemberPress plan, you can choose the marketing platform that best fits your needs.

This document is an overview of available MemberPress integrations and automation services for connecting MemberPress to email marketing platforms. Furthermore, it explains the integration option availability based on the MemberPress plan you subscribe to.

## MemberPress Marketing Platform Add-ons

MemberPress add-ons for marketing platforms provide direct and seamless integration. When connected via add-on, MemberPress will automatically send user information to your marketing platform when they register for a membership.

You can find and install any of these add-ons at Dashboard > MemberPress > Add-ons.

![Email Marketing Platform Integrations](data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyNTQyIiBoZWlnaHQ9IjEzMTciIHZpZXdCb3g9IjAgMCAyNTQyIDEzMTciPjxyZWN0IHdpZHRoPSIxMDAlIiBoZWlnaHQ9IjEwMCUiIHN0eWxlPSJmaWxsOiNjZmQ0ZGI7ZmlsbC1vcGFjaXR5OiAwLjE7Ii8+PC9zdmc+)
Some email marketing add-ons are available with all MemberPress plans. On the other hand, some require a Plus or Pro plan. Below, you will find all available email marketing add-ons listed by the MemberPress edition they require.
...
Add-ons will be available only if you're currently subscribed to the required MemberPress plan. Otherwise, if the add-on you need is not listed, you must upgrade your plan and plugin edition to use it.

## Other Marketing Platform Integrations

If you already use a marketing platform not supported by one of the add-ons mentioned above, there are some alternatives. If your platform allows it, you can connect MemberPress through one of the automation solutions.

Thus, if you're subscribed to MemberPress Plus or higher, you can use one of the following automation solutions with MemberPress:

These automation solutions can connect MemberPress with many different services, including various marketing platforms.

In addition, the following plugins support integrations with marketing platforms only. These plugins work with all MemberPress plans and editions (including the Basic):
